...
raw_data = pd.read_csv("data/input/audio_binarize_with_raw_data.csv")
for col in raw_data.columns:
    if col.startswith('Unnamed'):
        raw_data.drop(col, axis=1, inplace=True)

feature_df = pd.read_csv("data/input/audio_binarize_with_features.csv")
for col in raw_data.columns:
    if col.startswith('Unnamed'):
...
print("top 30")
f_30 = feature_df.columns[arg_indices][:300]
i_30 = imps[arg_indices][:300]
